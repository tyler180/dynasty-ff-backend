...
output "http_api_routes" {
  ...
  value = {
    public        = ["GET /health"]
    authenticated = ["GET /v1/free-agents/defensive-trends", "GET /v1/players/snaps", "GET /v1/players/stats", "GET /v1/snapshots/at", "GET /v1/snapshots/latest", "POST /v1/analyze", "POST /v1/snapshots/sync"]
  }
}
